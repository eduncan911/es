...
func dispatchEvents(given []es.Event, handlers env.EventHandlerMap) {
...
func verifyEvents(then []es.Event, actual []es.Event) *seq.Result {
	prepareArray := func(es []es.Event) []map[string]interface{} {
